...
public class NewElementAction extends AbstractGerumapAction {


    public NewElementAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(
                KeyEvent.VK_N, ActionEvent.CTRL_MASK));
        putValue(SMALL_ICON, loadIcon("/images/element32.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        MainFrame.getInstance().getProjectView().startNewElementState();
    }
}
